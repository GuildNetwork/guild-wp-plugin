...
class GuildNetwork_OptionsManager {
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            ...
            case 'false':
                return __('false', 'guild-network');

            case 'Administrator':
                return __('Administrator', 'guild-network');
            case 'Editor':
                return __('Editor', 'guild-network');
            case 'Author':
                return __('Author', 'guild-network');
            case 'Contributor':
                return __('Contributor', 'guild-network');
            case 'Subscriber':
                return __('Subscriber', 'guild-network');
            case 'Anyone':
                return __('Anyone', 'guild-network');
        }
        return $optionValue;
    }
